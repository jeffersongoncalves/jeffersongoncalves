...
const cliPythonList = sorted(plugins.cliPython).map(generatePythonCliRow).join('');
...
readme = readme.replace(/\[CLI_PYTHON\]/g, cliPythonList.trim());
...
readme = readme.replace(/\[TOTAL_COUNT\]/g, totalCount);
